...
/* Text of the date using local conventions. */
var dateString = thisDate.toLocaleDateString();
/* Insert a header with the date. */
var dateHTML = '<h2>' + dateString + '</h2>';
/* Find the day of the week. */
var thisDay = thisDate.getDay();
/* Get the HTML code of that day’s events. */
var eventHTML = getEvent(thisDay);
/* Insert the date header and the eventHTML variables before the end of the unionToday element contents. */
